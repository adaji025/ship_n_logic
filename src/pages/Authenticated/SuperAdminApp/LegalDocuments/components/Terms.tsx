...
const Terms = () => {
  return (
    <div className="p-10  text-dark-100">
      <div className="flex justify-between items-center">
        <div className="font-semibold">Preview</div>
        <button className="py-2 px-5 bg-white border rounded text-sm font-medium text-primary">Upload document</button>
      </div>
      <div className="mt-10 text-dark-100 leading-[28px]">
        Welcome to Ship N’ Logic! We are committed to protecting your personal
        information and your right to privacy. This Privacy Policy outlines the
      ...
      <div className="mt-5 text-black font-medium">Personal Information</div>
      ...
      <ul className="list-disc ml-6 grid gap-3 mt-2">
        <li>
          ...
          site content and layout, as well as for personalized recommendations.
        </li>
        <li>
          Frequency & Duration of Visits: Analyzed to gauge user engagement and
          potentially for A/B testing to improve the site.
        </li>
        <li>
        ...
        <li>
          Social Media Handles: If applicable, used for promotional purposes or
      ...
      <div className="mt-5 text-black font-medium">Third-Party Disclosure</div>
      <div className="mt-2">
      ...
      <div className="mt-5 text-black font-medium">Changes to This Policy</div>
      <div className="mt-2">
        We may update our Privacy Policy from time to time. We will notify you
        of any changes by updating the "Last Updated" date on this page.
      </div>

      <div className="mt-5 text-black font-medium">Contact Us</div>
      <div className="mt-2">
        If you have any questions about this Privacy Policy, please contact us
        at <span className="text-black font-medium">shipnlogic@gmail.org</span>
      </div>

      <div className="flex justify-center mt-5">
        <Button size="md" className="bg-primary text-white">Update Webpage</Button>
      </div>
    </div>
  );
};
